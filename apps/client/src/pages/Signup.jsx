                    ...
                    <div className="w-full max-w-md">
                        ...
                        <div className="bg-card border-2 border-border p-8" style={{ boxShadow: '8px 8px 0px 0px var(--shadow-color)' }}>
                            ...
                            <div className="text-center mb-8">
                                <h1 className="text-4xl font-bold text-card-foreground mb-2">Create Account</h1>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                {/* Full Name Field */}
                                <div>
                                    <label htmlFor="fullName" className="block text-sm font-bold text-card-foreground mb-2">
                                        Full Name
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label htmlFor="confirmPassword" className="block text-sm font-bold text-card-foreground mb-2">
                                        Confirm Password
                                    </label>
                                    <input
                                        type="password"
                                ...
                                <div className="flex items-start">
                                    <input
                                        ...
                                        className="w-4 h-4 mt-1 border-2 border-border bg-background cursor-pointer"
                                    />
                                    <label htmlFor="terms" className="ml-2 text-sm text-card-foreground cursor-pointer">
                                        I agree to the{' '}
